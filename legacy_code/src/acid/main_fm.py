...
def f(filenames):
    ...
    for filename in filenames:
        ...
        hessian_fm = data.map_overlap(hessian_feature_map)
        haralick_fm = data.map_overlap(haralick_feature_map)
        hessian_measurements = measure_feature_map(hessian_fm,mask)
        haralick_measurements = measure_feature_map(haralick_fm,mask)
